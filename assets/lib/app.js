...
var manejarMensaje = function manejarMensaje(message) {
...
var manejarAlert = function manejarAlert(content) {
...
formulario.addEventListener("submit", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var data, dataObjeto, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          data = new FormData(formulario);
          dataObjeto = Object.fromEntries(data);
          _context.prev = 3;
          _context.next = 6;
          return manejarMensaje(msg);
        case 6:
          res = _context.sent;
          msg = dataObjeto.mensaje;
          console.log("--Para: ".concat(dataObjeto.destinatario, "\n").concat(dataObjeto.mensaje));
          setTimeout(function () {
            msg = "";
          }, 5000);
          manejarAlert(res);
